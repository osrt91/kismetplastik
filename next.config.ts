...
const securityHeaders = [
  ...
  { key: "Strict-Transport-Security", value: "max-age=31536000; includeSubDomains; preload" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://supabase.kismetplastik.com https://cdn.kismetplastik.com https://img.youtube.com https://www.google-analytics.com",
...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "supabase.kismetplastik.com",
        pathname: "/storage/v1/object/public/**",
      },
      {
        protocol: "https",
        hostname: "cdn.kismetplastik.com",
        pathname: "/**",
      },
    ],
  },
