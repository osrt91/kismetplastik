        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-6">
          <AnimateOnScroll animation="fade-up">
            ...
            <h1 className="mb-4 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">
              {t("production_hero", "title", p.heroTitle)}
            </h1>
            <div className="mt-4 mb-6 h-1 w-20 rounded-full bg-[#F59E0B]" />
            <p className="max-w-2xl text-lg text-white/70">
              {t("production_hero", "subtitle", p.heroSubtitle)}
            </p>
          </AnimateOnScroll>
        </div>
      </div>
          ...
          <AnimateOnScroll animation="fade-left">
            <div>
              <span className="mb-3 inline-block text-sm font-bold uppercase tracking-widest text-[#F59E0B]">
                {t("production_facility", "title", p.facilityOverline)}
              </span>
              <h2 className="mb-6 text-2xl font-extrabold text-[#0A1628] dark:text-white sm:text-3xl">
                {t("production_facility", "subtitle", p.facilityTitle)}
              </h2>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-6 lg:py-24">
        <AnimateOnScroll animation="fade-up">
          <div className="mb-12 text-center">
            <span className="mb-3 inline-block text-sm font-bold uppercase tracking-widest text-[#F59E0B]">
              {t("production_machines", "title", p.machinesOverline)}
            </span>
            <h2 className="mb-4 text-3xl font-extrabold text-[#0A1628] dark:text-white sm:text-4xl">
              {t("production_machines", "subtitle", p.machinesTitle)}
            </h2>
          </div>
        </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="relative">
              ...
              >
                ...
                {t("production_cta", "cta_text",
                  locale === "tr" ? "Fabrika Turu Randevusu Al" : "Schedule Factory Tour"
                )}
                <ArrowRight size={16} />
              </Link>
            </div>
