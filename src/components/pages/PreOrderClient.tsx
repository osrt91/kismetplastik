...
const preOrderSchema = z.object({
  ...
  phone: z.string().min(7, "Gecerli bir telefon numarasi giriniz."),
  productName: z.string().min(2, "Urun adi/kodu gereklidir."),
  quantity: z.number().int().positive("Miktar pozitif bir sayi olmalidir."),
...
const texts = {
  tr: {
    ...
    breadcrumbPreOrder: "On Siparis",
    heroTitle: "On Siparis",
    heroSubtitle:
      "Stokta bulunmayan veya ozel uretim urunler icin on siparis verin. Uretim planlamamiza dahil edelim ve size en kisa surede temin edelim.",
    step1: "Formu Doldurun",
    step2: "Onay Alin",
    step3: "Uretim Baslat",
    formTitle: "On Siparis Formu",
    formHint: "Tum zorunlu alanlari doldurunuz.",
    sectionContact: "Iletisim Bilgileri",
    sectionProduct: "Urun Bilgileri",
    fieldName: "Ad Soyad",
    fieldCompany: "Firma Adi",
    fieldEmail: "E-posta",
    fieldPhone: "Telefon",
    fieldProduct: "Urun Adi / Kodu",
    fieldProductPlaceholder: "Orn: PET Sise 100ml, KP-2045",
    fieldQuantity: "Miktar (adet)",
    fieldQuantityPlaceholder: "Orn: 5000",
    fieldDate: "Tercih Edilen Teslim Tarihi",
    fieldNotes: "Ek Notlar",
    fieldNotesPlaceholder:
      "Ozel uretim detaylari, renk, boyut veya diger isteklerinizi belirtiniz...",
    submitButton: "On Siparis Gonder",
    submitting: "Gonderiliyor...",
    successTitle: "On Sipaarisiniz Alindi!",
    successMessage:
      "Talebiniz basariyla kaydedildi. Ekibimiz en kisa surede sizinle iletisime gececektir.",
    errorGeneral: "Bir hata olustu. Lutfen tekrar deneyin.",
    errorConnection:
      "Baglanti hatasi. Lutfen internet baglantinizi kontrol edin.",
    errorTooMany:
      "Cok fazla istek gonderdiniz. Lutfen biraz bekleyip tekrar deneyin.",
    whyPreOrder: "On Siparis Avantajlari",
    benefit1Title: "Uretim Onceligi",
    benefit1Desc: "On siparisler uretim kuyrugunda oncelikli olarak planlanir.",
    benefit2Title: "Fiyat Garantisi",
    benefit2Desc: "Siparis anindaki fiyat uzerinden fatura kesilir.",
    benefit3Title: "Stok Bildirimi",
    benefit3Desc: "Urun hazir oldugunda aninda bilgilendirilirsiniz.",
    haveQuestions: "Sorulariniz mi var?",
  },
  en: {
    breadcrumbHome: "Home",
