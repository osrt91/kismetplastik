              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-[#0A1628]/5 dark:border-white/10 bg-[#FAFAF7] dark:bg-white/5 p-8 pt-10 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="relative">
                  ...
                  <h3 className="mb-3 text-xl font-bold text-[#0A1628] dark:text-white">
                    {t("about_mission", "title", a.missionTitle)}
                  </h3>
                  <p className="flex-1 leading-relaxed text-neutral-600 dark:text-neutral-300">
                    {t("about_mission", "content", a.missionText)}
                  </p>
                </div>
              </div>
            </AnimateOnScroll>
            <AnimateOnScroll animation="fade-up" delay={100}>
              <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-[#F59E0B]/10 dark:border-[#F59E0B]/20 bg-[#FAFAF7] dark:bg-white/5 p-8 pt-10 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="relative">
                  ...
                  <h3 className="mb-3 text-xl font-bold text-[#0A1628] dark:text-white">
                    {t("about_vision", "title", a.visionTitle)}
                  </h3>
                  <p className="flex-1 leading-relaxed text-neutral-600 dark:text-neutral-300">
                    {t("about_vision", "content", a.visionText)}
                  </p>
                </div>
              </div>
            </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="mb-4 text-2xl font-extrabold text-white">
                {t("about_certs", "title", a.certsTitle)}
              </h2>
              <p className="mb-8 max-w-xl text-white/70">
                {t("about_certs", "subtitle", a.certsSubtitle)}
              </p>
